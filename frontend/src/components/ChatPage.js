              ...
              {!hasFinancialProfile ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    To get personalized financial advice, please set up your financial profile first
                  </p>
                  <a 
                    href="/setup"
                    className="btn-primary px-6 py-3 rounded-lg text-white no-underline inline-block"
                  >
